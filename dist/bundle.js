...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /Volumes/HDD1/Phaser-Game-ES6/src/main.js */298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Menu = __webpack_require__(/*! ./states/Menu */ 309);

	var _Menu2 = _interopRequireDefault(_Menu);

	var _Game = __webpack_require__(/*! ./states/Game */ 311);
	...
	var Game = function (_Phaser$Game) {
	  ...
	  function Game() {
	    ...
	    var width = Math.ceil(1080 * gameRatio);
	    var heigth = 1080; // <== MAX BACKGROUND

	    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, width, heigth, _phaser2.default.AUTO, 'freixas-farm', null));
...
/***/ function(module, exports) {
	...
	var safeZone = exports.safeZone = function safeZone(context) {
	  ...
	  var currentHeightWidthRatio = context.game.height / context.game.width;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Background = __webpack_require__(/*! ../sprites/Background */ 310);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      this.background_sol = new _Background2.default({
	        game: this.game,
	        x: 0,
	        y: 0,
	      ...
	      this.background_arboles = new _Background2.default({
	        game: this.game,
	        x: 0,
	        y: 0,
	      ...
	      this.background_ground = new _Background2.default({
	        game: this.game,
	        x: 0,
	        y: 0,
	      ...
	      this.game.add.tween(this.gameText.scale).to({ x: 1.2, y: 1.2 }, 1000, _phaser2.default.Easing.Linear.NONE, true, 0, 1000, true);
	      ...
	      this.game.add.tween(this.startButton.scale).to({ x: 0.9, y: 0.9 }, 1000, _phaser2.default.Easing.Linear.NONE, true, 0, 1000, true);
	      (0, _utils.centerGameObjects)([this.gameText, this.startButton]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$TileSprite) {
	  ...
	  function _class(_ref) {
	    ...
	    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, x, y, game.width, game.height, asset));

	    _this.game = game;
	    _this.velocity = -velocity;
	    _this.game.time.events.loop(_phaser2.default.Timer.SECOND * 6, _this.updateVelocity, _this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Ground = __webpack_require__(/*! ../sprites/Ground */ 312);

	var _Ground2 = _interopRequireDefault(_Ground);

	var _Pool = __webpack_require__(/*! ../sprites/Pool */ 313);

	var _Pool2 = _interopRequireDefault(_Pool);

	var _Runner = __webpack_require__(/*! ../sprites/Runner */ 316);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    key: 'init',
	    value: function init(life, score) {
	      this.life = life;
	      this.score = score;
	      this.mute = this.mute.bind(this);
	    ...
	    value: function create() {
	      ...
	      this.runner = new _Runner2.default({
	        game: this.game,
	      ...
	      this.cowGenerator = this.game.time.events.loop(_phaser2.default.Timer.SECOND * 2, this.generateCows, null);
	      this.game.add.existing(this.cows);

	      this.chickens = this.game.add.group();
	      this.chickenGenerator = this.game.time.events.loop(_phaser2.default.Timer.SECOND * 120, this.generateChickens, null);
	      ...
	      (0, _utils.centerGameObjects)([this.scoreText]);
	      ...
	      this.game.input.onDown.add(function () {
	        ...
	        _this2.continueButton.visible = false;
	      });
	    }
	  }, {
	    key: 'update',
	    value: function update() {
	      ...
	      this.cows.forEach(function (pool) {
	        _this3.checkScore(pool);
	        _this3.game.physics.arcade.collide(_this3.runner, pool, _this3.gameOver, null, null);
	      });
	      this.chickens.forEach(function (pool) {
	        _this3.checkLife(pool);
	      });
	    }
	  }, {
	    key: 'generateCows',
	    value: function generateCows() {
	      var pool = this.cows.getFirstExists(false);
	      if (!pool) {
	        pool = new _Pool2.default({
	          game: this.game,
	          parent: this.cows,
	          name: 'CowPool',
	          asset: 'cow',
	    ...
	    key: 'generateChickens',
	    value: function generateChickens() {
	      var pool = this.chickens.getFirstExists(false);
	      if (!pool) {
	        pool = new _Pool2.default({
	          game: this.game,
	    ...
	    key: 'checkScore',
	    value: function checkScore(pool) {
	    ...
	    value: function shutdown() {
	      this.game.input.keyboard.removeKey(_phaser2.default.Keyboard.SPACEBAR);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Cow = __webpack_require__(/*! ./Cow */ 314);

	var _Cow2 = _interopRequireDefault(_Cow);

	var _Chicken = __webpack_require__(/*! ./Chicken */ 315);
	...
	var _class = function (_Phaser$Group) {
	  ...
	  function _class(_ref) {
	    ...
	    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, parent, name));

	    _this.game = game;
	    var Type = asset === 'cow' ? _Cow2.default : _Chicken2.default;
	    _this.sprite = new Type({
	      game: _this.game,
	      x: 0,
	      y: 0,
	      asset: asset
	    ...
	    _this.velocity = velocity; // COW = -500 CHICKEN = -300
	    _this.game.time.events.loop(_phaser2.default.Timer.SECOND * 6, _this.updateVelocity, _this);
	    return _this;
	  }
	  ...
	  _createClass(_class, [{
	    ...
	    value: function reset(x, y) {
	      ...
	      this.x = x;
	      this.y = y;
	      var position = this.game.rnd.integerInRange(this.velocity - this.velocity * 0.1, this.velocity + this.velocity * 0.1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    ...
	    _this.safeZone = (0, _utils.safeZone)(_this);
	    _this.height = _this.safeZone.height * 0.11; // 11% of safeZone
	    _this.scale.x = _this.scale.y; // scale width same as height
	    _this.body.setSize(_this.width - 40, _this.height - 15, 40, 50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    ...
	    _this.height = _this.safeZone.height * 0.11; // 11% of safeZone
	    _this.scale.x = _this.scale.y; // scale width same as height
	    _this.body.setSize(_this.width - 20, _this.height - 15, -10, 50);
	    _this.anchor.setTo(0.5, 0.5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    ...
	    _this.upZone = new _phaser2.default.Rectangle(0, 100, _this.game.width, _this.game.height);
	    _this.soundUp = _this.game.add.audio('up');
	    _this.game.add.existing(_this);
	    return _this;
	  }
	  ...
	  _createClass(_class, [{
	    ...
	    value: function update() {
	      ...
	      // Keyboard controls
	      var runnerKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.SPACEBAR);
	    ...
	    value: function freeze() {
	      ...
	      this.game.time.events.add(800, function () {
	        _this2.animations.paused = false;
	      });
	    }
	  }]);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      this.game.add.tween(this.startButton.scale).to({ x: 1.1, y: 1.1 }, 1000, _phaser2.default.Easing.Linear.NONE, true, 0, 1000, true);
	      (0, _utils.centerGameObjects)([this.bestText, this.scoreText, this.startButton]);
