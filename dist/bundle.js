...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /Users/edgar/Proyectos/Games/farm-of-freixa/src/main.js */298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameOver = __webpack_require__(/*! ./states/GameOver */ 316);
	...
	var Game = function (_Phaser$Game) {
	  ...
	  function Game() {
	    ...
	    var width = document.documentElement.clientWidth > 768 ? 800 : document.documentElement.clientWidth;
	    var height = document.documentElement.clientHeight > 700 ? 600 : document.documentElement.clientHeight;

	    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, width, height, _phaser2.default.AUTO, 'freixas-farm', null));
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function preload() {
	      ...
	      this.load.image('cow', 'assets/images/cow1.png');
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      this.game.add.tween(this.ready.scale).to({ x: 1.1, y: 1.1 }, 1000, _phaser2.default.Easing.Linear.NONE, true, 0, 1000, true);
	      ...
	      (0, _utils.centerGameObjects)([this.ready, this.gameText, this.startButton]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Runner = __webpack_require__(/*! ../sprites/Runner */ 315);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      this.cowGenerator = this.game.time.events.loop(_phaser2.default.Timer.SECOND * 2, this.generateCows, this);
	    ...
	    value: function update() {
	      ...
	      this.cows.forEach(function (pool) {
	        _this2.checkScore(pool);
	        _this2.game.physics.arcade.collide(_this2.runner, pool, _this2.gameOver, null, _this2);
	      });
	    }
	  }, {
	    key: 'generateCows',
	...
	var _class = function (_Phaser$Group) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function reset(x, y) {
	      ...
	      this.x = x;
	      this.y = y;
	      var position = this.game.rnd.integerInRange(this.velocity - 30, this.velocity + 40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    ...
	    _this.game.physics.arcade.enableBody(_this);
	    _this.body.setSize(_this.width * 0.04, (_this.height - 200) * 0.04, -20, 200);
	    _this.anchor.setTo(0.5, 0.5);
	    _this.scale.setTo(0.04, 0.04);
	    _this.body.allowGravity = false;
	    _this.body.immovable = true;
	    return _this;
	  }
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      this.game.add.tween(this.gameOver.scale).to({ x: 1.1, y: 1.1 }, 1000, _phaser2.default.Easing.Linear.NONE, true, 0, 1000, true);
	      ...
	      (0, _utils.centerGameObjects)([this.gameOver, this.scoreText, this.timerText]);

	      this.timer = this.game.time.create();
	      this.timerEvent = this.timer.add(_phaser2.default.Timer.SECOND * 5, this.returnMenu, this);
	      this.timer.start();
	    }
	  }, {
	    key: 'render',
